...
public class MsaController {
	...
	public ResponseEntity<?> createService(@RequestBody String request) {

		String response = msaService.processMsaService(request);
		return new ResponseEntity<>(response, HttpStatus.OK);

	}

	@DeleteMapping("/cxf/openroadm/openroadm-services/delete")
	public ResponseEntity<?> deleteService(@RequestBody String request) {
		String response = msaService.processMsaServiceDelete(request);
		return new ResponseEntity<>(response, HttpStatus.OK);
